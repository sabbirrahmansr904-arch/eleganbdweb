...
export default function InvoiceTemplate({ order, preview = false }: InvoiceProps) {
  ...
  return (
    <div 
      id="invoice-to-print" 
      className={`bg-[#F8F9FD] text-black mx-auto select-none text-[11px] leading-relaxed box-border flex flex-col justify-between ${
        preview 
          ? "w-[148mm] min-h-[210mm] h-[210mm] p-6 shadow-2xl border border-gray-200 rounded-2xl relative scale-[0.95] md:scale-100 origin-top overflow-hidden" 
          : "hidden print:flex w-[148mm] min-h-[210mm] h-[210mm] overflow-hidden p-6"
      }`}
    ...
    >
      ...
      {/* Elegant Footer Thank You Message - Positioned strictly at bottom */}
      <div className="mt-auto pt-3 border-t border-dashed border-gray-300 text-center space-y-0.5 shrink-0">
