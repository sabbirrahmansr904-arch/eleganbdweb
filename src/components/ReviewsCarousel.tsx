...
const generateReviews = (): Review[] => {
  ...
  reviews.push({
    id: 1,
    name: "POLLOB DAS",
    text: "মানসম্মত পণ্য—যারা নিতে চান তারা নিশ্চিন্তে নিতে পারেন। আমি তাদের ডিসপ্লে সেন্টার থেকে শার্টগুলো নিয়েছি। খুবই সুন্দর এবং আরামদায়ক। ধন্যবাদ, Man's Avenue 🥰",
    rating: 5,
    date: "10 hours ago",
  ...
  for (let i = 2; i <= 100; i++) {
    ...
    const text = textTemplate.replace("Man's Avenue", "Man's Avenue " + emoji);
